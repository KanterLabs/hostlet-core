...
assert_contains "${RELEASE_WORKFLOW}" 'publication_sha: ${{ steps.resolve.outputs.publication_sha }}'
assert_contains "${RELEASE_WORKFLOW}" 'publication_tree: ${{ steps.resolve.outputs.publication_tree }}'
assert_contains "${RELEASE_WORKFLOW}" '"publication": {'
assert_contains "${RELEASE_WORKFLOW}" '"commit_sha": os.environ["PUBLICATION_SHA"]'
assert_contains "${RELEASE_WORKFLOW}" '"tree_sha": os.environ["PUBLICATION_TREE"]'
...
assert_contains "${RELEASE_WORKFLOW}" "'+refs/heads/main:refs/remotes/origin/main'"
assert_contains "${RELEASE_WORKFLOW}" "git rev-parse --verify 'refs/remotes/origin/main^{commit}'"
assert_contains "${RELEASE_WORKFLOW}" "git rev-parse --verify 'refs/remotes/origin/main^{tree}'"
assert_contains "${RELEASE_WORKFLOW}" 'git merge-base --is-ancestor'
assert_contains "${RELEASE_WORKFLOW}" 'does not match current main tree'
assert_contains "${RELEASE_WORKFLOW}" 'target_commitish: ${{ needs.release-source.outputs.publication_sha }}'
...
assert_contains "${PR_WORKFLOW}" 'components: rustfmt, clippy'
