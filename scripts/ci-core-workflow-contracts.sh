...
assert_contains "${ROOT}/.github/workflows/release.yml" 'CARGO_BUILD_JOBS: "8"'
...
assert_contains "${ROOT}/.github/actionlint.yaml" 'homelab-heavy'
assert_not_contains "${PR_WORKFLOW}" 'runs-on: ubuntu-latest'
